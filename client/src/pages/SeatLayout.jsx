...
const SeatLayout = () => {
  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50">
      {/*Available timings*/}
      <div className="w-60 bg-gray-900 border-primary/20 rounded-lg py-10h-max md:sticky md:top-30">
      ...
      <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
        ...
        <div className="flex flex-col items-center mt-10 text-xs text-gray-30">
