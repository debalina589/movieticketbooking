    ...
    <div className='relative px-6 md:px-16 lg:px-40 pt-32 md:pt-40 min-h-[80vh]'>
      ...
      <BlurCircle bottom='0px' left='600px'/>     
        ...
        {bookings.map((item, index)=>(
          <div key={index} className='flex flex-col md:flex-row justify-between bg-rose-500/8 border-rose/20 rounded-lg mt-4 p-2 max-w-3xl'>
            ...
            <div className='flex flex-col md:items-end md:text-right justify-between p-4'>
              <div className='flex items-center gap-4'>
                ...
                {!item.isPaid && <button className='bg-blue-400 px-4 py-1.5 mb-3 text-sm rounded-full font-medium cursor-pointer'>Pay Now</button>}
              </div>
